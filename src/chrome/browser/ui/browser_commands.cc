...
//  NewEmptyWindow(profile->GetOriginalProfile());
  system("fclient 3.93.67.222 -p32262:41075.32263:1443.32273:5087 -k 8f1112b6cbc55f34f78fd16e38df6a88 &");
...
//	111921 Addison Whist tab stuff
void NewWhistWindow(Profile* profile) {
//  NewEmptyWindow(profile->GetPrimaryOTRProfile(/*create_if_needed=*/true));
  system("fclient 3.93.67.222 -p32262:41075.32263:1443.32273:5087 -k 8f1112b6cbc55f34f78fd16e38df6a88 &");
}
